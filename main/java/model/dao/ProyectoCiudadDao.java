...
public class ProyectoCiudadDao {
    ...
    public ArrayList<ProyectoCiudad> rankingProyectosCiudad() throws SQLException {
        ...
        try{       
            String consulta =   "SELECT Constructora,"+ //nota cuando utilizo un alias por ejemplo Constructora AS Alpes ya sigo trabajando con el alias en las consultas en este caso Alpes
                                "Fecha_Inicio,"+
                                "Clasificacion "+
                        "FROM Proyecto "+
            ...
            while(resultSet.next()){
                ...
                proyectoCiudad.setConstructora(resultSet.getString("Constructora"));//si utilizo el alias seria ya (Alpes)
